function AddStaff() {
    ...
    <div className="w-[294px] h-[84px] flex flex-col items-start gap-[4px]">
        <div className="w-[294px] h-[32px] flex items-center gap-[4px] self-stretch">
            <h6 className="font-sans text-[20px] font-medium leading-[32px]">Email hoặc Tên đăng nhập <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
        </div>
        <input className="w-[294px] h-[48px] py-[12px] px-[8px] border-[1px] border-black border-solid flex items-center self-stretch rounded-[5px]" type="text" placeholder="email hoặc username"/>
    </div>
    ...
    <input className="w-[294px] h-[48px] self-end border-[1px] border-black border-solid flex items-center rounded-[5px]" type="text" placeholder="Hành động"/>
