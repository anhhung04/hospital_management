    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
      <div className="bg-white w-[769px] h-[484px] flex flex-col  ml-[11%] p-[24px] gap-[24px] rounded-[32px] ">
        ...
        <div className="h-[300px] w-full grid grid-cols-2 items-start  gap-x-[41px]">
            ...
            <div className="w-[721px] h-[84px] flex flex-col col-span-2 items-start gap-[4px]">
                <div className="w-[721px] h-[32px] flex items-center gap-[4px] self-stretch">
                    <h6 className="font-sans text-[20px] font-medium leading-[32px]">Mã lô hàng <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
                </div>
                <div className="w-[721px] gap-[8px] h-[48px] py-[12px] px-[8px] flex items-center self-stretch rounded-[5px] border-[1px] border-black border-solid">
                    <input className="w-full h-[24px] py-[12px] px-[8px] border-0  flex items-center self-stretch rounded-[5px]" type="text" placeholder="#000001" onChange={(e)=>setTypeCheck(e.target.value)}/>
            ...
            <div className="w-[340px] h-[84px] flex flex-col items-start gap-[4px]">
                <div className="w-[340px] h-[32px] flex items-center gap-[4px] self-stretch">
                    <h6 className="font-sans text-[20px] font-medium leading-[32px]">Ngày nhập <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
                </div>
                <div className="w-[340px] gap-[8px] h-[48px] py-[12px] px-[8px] flex items-center self-stretch rounded-[5px] border-[1px] border-black border-solid">
            ...
            <div className="w-[340px] h-[84px] flex flex-col items-start gap-[4px]">
                <div className="w-[340px] h-[32px] flex items-center gap-[4px] self-stretch">
                    <h6 className="font-sans text-[20px] font-medium leading-[32px]">Hạn sử dụng <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
                </div>
                <div className="w-[340px] gap-[8px] h-[48px] py-[12px] px-[8px] flex items-center self-stretch rounded-[5px] border-[1px] border-black border-solid">
                    <input className="w-[402px] h-[24px] py-[12px] px-[8px] border-0  flex items-center self-stretch rounded-[5px]" type="text" placeholder="10/03/2024" onChange={(e)=>setDate(e.target.value)}/>
                    <img src="/images/Patient_calender.png" alt="" />
            ...
            <div className="w-[340px] h-[84px] flex flex-col items-start gap-[4px]">
                <div className="w-[340px] h-[32px] flex items-center gap-[4px] self-stretch">
                    <h6 className="font-sans text-[20px] font-medium leading-[32px]">Số lượng nhập <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
                </div>
                <div className="w-[340px] gap-[8px] h-[48px] py-[12px] px-[8px] flex items-center self-stretch rounded-[5px] border-[1px] border-black border-solid">
                    <input className="w-[402px] h-[24px] py-[12px] px-[8px] border-0  flex items-center self-stretch rounded-[5px]" type="text" placeholder="1000" onChange={(e)=>setDateResult(e.target.value)}/>
                    {/* <img src="/images/Patient_calender.png" alt="" /> */}
                </div>
            </div>
            ...
            <div className="w-[340px] h-[84px] flex flex-col items-start gap-[4px]">
                <div className="w-[340px] h-[32px] flex items-center gap-[4px] self-stretch">
                    <h6 className="font-sans text-[20px] font-medium leading-[32px]">Số lượng còn lại <span className="text-[#F00] text-[20px] font-medium leading-8">*</span></h6>
                </div>
                <div className="w-[340px] gap-[8px] h-[48px] py-[12px] px-[8px] flex items-center self-stretch rounded-[5px] border-[1px] border-black border-solid">
                    <input className="w-[402px] h-[24px] py-[12px] px-[8px] border-0  flex items-center self-stretch rounded-[5px]" type="text" placeholder="1000" onChange={(e)=>setDateResult(e.target.value)}/>
                    {/* <img src="/images/Patient_calender.png" alt="" /> */}
