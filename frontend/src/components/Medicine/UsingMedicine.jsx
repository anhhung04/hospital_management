import AddResult from "../Patients/PatientsAdd/addresult";
import Alert from "../Alert";
import { useState } from "react";
import PropTypes from 'prop-types';

UsingMedicine.propTypes = {
  isAddResult: PropTypes.bool,
  setAddResult: PropTypes.func,
};

function UsingMedicine(props) {
  ...
  return (
    <>
      ...
      <div className="w-[960px] h-[392px] flex flex-col items-center gap-[20px] mt-[40px] mb-[99px]">
        <div className="w-[960px] h-[44px] flex items-center content-center self-stretch mb-[26px] gap-[330px]">
          <div className="w-[300px] h-[36px] flex items-center gap-[6px]">
            ...
            <div className="w-[300px] h-[36px] flex items-center gap-[10px]">
              <h5 className="font-sans text-[24px] font-semibold leading-12 text-[#032B91]">
                Thông tin lượt sử dụng
              </h5>
            </div>
          </div>
