...
class Medicine(Base):
    ...
    medical_warehouse_management = relationship("MedicalWarehouseManagement", back_populates="medicine")
    medicine_report = relationship("MedicineReport", back_populates="medicine")
